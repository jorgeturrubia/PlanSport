...
export class DashboardLayoutComponent {
  ...
  onUserMenuClick(): void {
    // This will be handled by the UserProfileDropdownComponent
   ...
   */
  onPortalClick(): void {
    console.log('Navigating to user portal from layout...');
  ...
  onLogoutClick(): void {
    ...
    // This should be handled by a parent component or service
  }
}
