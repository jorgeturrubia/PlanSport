...
import { ThemeToggleComponent } from '../../../shared/components/theme-toggle/theme-toggle.component'; // Import ThemeToggleComponent

@Component({
  selector: 'app-auth-tabs',
  standalone: true,
  imports: [CommonModule, RouterOutlet, RouterLink, FontAwesomeModule, ThemeToggleComponent], // Add ThemeToggleComponent
