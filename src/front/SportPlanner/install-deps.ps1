...
Write-Host ''
Write-Host '📝 Archivos ya configurados:' -ForegroundColor Cyan
Write-Host '   ✅ .postcssrc.json (configurado)'
Write-Host '   ✅ src/styles.css (con Tailwind v4)'
Write-Host '   ⏳ src/environments/ (pendiente de configurar)'
Write-Host ''
